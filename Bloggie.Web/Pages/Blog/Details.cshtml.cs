...
namespace Bloggie.Web.Pages.Blog
{
	public class DetailsModel : PageModel
	{
		...
		public DetailsModel(IBlogPostRepository blogPostRepository, IBlogPostLikeRepository blogPostLikeRepository, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager, IBlogPostCommentRepository blogPostCommentRepository)
		{
		...
		private async Task GetComments()
		{
			...
			var blogCommentViewModel = new List<BlogComment>();
			foreach (var blogPostComment in blogPostComments)
			{
				blogCommentViewModel.Add(new BlogComment
				{
